    ...
    <section id="contact" className="py-20 bg-card">
      <div className="container px-4 mx-auto" ref={ref}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className={`transition-all duration-1000 ${inView ? 'opacity-100' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '200ms' }}>
          ...
          <div className={`transition-all duration-1000 ${inView ? 'opacity-100' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: '400ms' }}>
            ...
            <form className="space-y-6">
              ...
              <button 
                type="submit"
                className="px-6 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/80 transition-all duration-300 w-full md:w-auto"
              >
                Send Message
              </button>
            </form>
